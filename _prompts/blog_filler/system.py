...
예시: "거북목 교정 스트레칭 비용은", "마운자로 다이어트 효과 가격 알아보니"
패턴: [메인키워드] [서브키워드1] [서브키워드2] [미완성 어미]""",
    "2": """총정리형: A부터 Z까지 모든 정보를 담았음을 강조
예시: "마운자로 효과 체중 감량 원리부터 주의점까지 총정리", "거북목 교정 운동 가격 부작용 완벽정리"
패턴: [메인키워드] [서브키워드1] [서브키워드2] [정보1]부터 [정보2]까지 총정리""",
    "3": """숫자형: 구체적 숫자로 신뢰감과 정보량 어필
예시: "흑염소 효능 기력회복 7가지 총정리", "거북목 교정 스트레칭 효과 5가지"
패턴: [메인키워드] [서브키워드1] [서브키워드2] N가지""",
    "4": """권유형: 독자에게 직접 말 걸듯 권유
예시: "거북목 교정 스트레칭 고민이라면 꼭 읽어보세요", "마운자로 다이어트 효과 헷갈린다면 확인해보세요"
패턴: [메인키워드] [서브키워드1] [서브키워드2] [상황]이라면 [권유]""",
    "5": """비교형: 두 가지 이상을 비교하는 구조
예시: "거북목 일자목 차이 교정 방법 비교", "위고비 마운자로 효과 가격 뭐가 다를까"
패턴: [메인키워드] [비교대상] [서브키워드1] [서브키워드2] 차이/비교""",
    "6": """대상형: 특정 대상을 명시하여 타겟팅
예시: "거북목 교정 스트레칭 직장인을 위한 가이드", "흑염소 효능 기력회복 중년 남성 필독"
패턴: [메인키워드] [서브키워드1] [서브키워드2] [대상]을 위한""",
    "7": """이유형: 왜 알아야 하는지 이유 제시
예시: "거북목 교정 스트레칭 지금 시작해야 하는 이유", "마운자로 다이어트 효과 주목받는 이유"
패턴: [메인키워드] [서브키워드1] [서브키워드2] [행동]해야 하는 이유""",
    "8": """필수형: 반드시 알아야 함을 강조
예시: "거북목 교정 스트레칭 꼭 알아야 할 핵심", "마운자로 부작용 주의사항 필수 체크리스트"
패턴: [메인키워드] [서브키워드1] [서브키워드2] 꼭 알아야 할 [내용]""",
}
