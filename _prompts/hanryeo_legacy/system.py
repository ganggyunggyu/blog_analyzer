"""한려담원 - SEO Blog System Prompt (레거시 v3)
...
- 본문 내용만 출력 (자 수, 섹션 번호 등 메타 정보 출력 안 함)
...
7. ✔ 타겟 연결: 80~120단어, 키워드 증상 → 흑염소 자연스러운 연결
