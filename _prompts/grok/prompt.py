...
총 글자수: 4000단어 이상 4500단어 이하로 작성할 것.
너무 짧거나 길면 네이버 노출에 불리하므로 반드시 범위 내 작성.
절대로 4000단어 미만으로 작성하지 말 것. 부족하면 각 소제목의 내용을 더 풍부하게 채울 것.

소제목별 배분:
- 1~3번 소제목 합산: 1500단어 내외
- 4번 소제목: 1500단어 이상
- 5번 소제목: 800단어 이상
...
## 원고 길이
총 글자수는 4000단어 이상 4500단어 이하로 작성할 것
절대로 4000단어 미만으로 작성하지 말 것
부족하면 각 소제목의 내용을 더 구체적이고 풍부하게 채울 것
