...
10. 문단정리 깔끔하게 해야해 한줄당짧게 20~25자 정도로 해야합니다. 2~5줄마다 줄바꿈 해야합니다. 한줄당 줄바꿈X
...
1. 원고의 공백을 모두 제거했을 때 문자열 길이가 반드시 2000~2300자 사이여야 합니다.
2. 작성이 끝나면, 공백 제거 후 길이를 계산하세요.
3. 길이가 2000보다 작거나 2300보다 크면 조건을 만족하도록 수정하세요.
