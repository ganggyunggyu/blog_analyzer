...
def gpt_4_v3_gen(user_instructions: str, ref: str = "", category: str = "") -> str:
    ...
    system_prompt = get_gpt_system_prompt(
        category=category,
        mongo_data=mongo_data,
    )

    user_prompt = get_gpt_user_prompt(
        keyword=keyword,
        note=note,
        ref=ref,
    )
    ...
    try:
        ...
        print(f"OpenAI API 오류: {api_error}")
        raise api_error
