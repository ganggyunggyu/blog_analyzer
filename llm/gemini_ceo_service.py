"""Gemini CEO - Gemini 3 Flash + CEO 프롬프트 원고 생성 서비스"""
...
def gemini_ceo_gen(user_instructions: str, ref: str = "", category: str = "") -> str:
    """Gemini 3 Flash + CEO 프롬프트를 사용한 원고 생성"""
    ...
    print(f"[GEMINI-CEO] 생성완료 | {length_no_space}자 | {elapsed:.2f}s")
